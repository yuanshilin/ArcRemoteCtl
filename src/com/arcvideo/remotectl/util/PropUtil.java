package com.arcvideo.remotectl.util;
...
/**
 * {@link com.arcvideo.remotectl.linkmodule.ArcEventManager} RemoteCtlSDK Prop 工具类 </br>
 * </br>
 * * 接口功能：</br>
 * <ol>
...
public class PropUtil {
    ...
    /**
     * 获取 float 类型 Prop 值 </br>
     * </br>
     * @param key Prop key </br>
     * @return Prop value </br>
     */
    public static float getFloatFromProp(String key, float def) {
        String value = "";
